  ...
  return (
    <div className='w-full  flex flex-col gap-5 py-12 px-8 md:px-16 lg:px-24 bg-[#F7F6F2]'>
      ...
      <div className='flex flex-col'>
        <div className='flex flex-col gap-5 md:flex-row  justify-between py-12  md:px-16 lg:px-24'>
          <h1 className=' md:text-2xl lg:text-4xl font-bold text-red-600'> Choose Your Favourite</h1>

          <div className='flex  items-center overflow-x-auto scrollbar-hide whitespace-nowrap md:px-5 py-5  gap-5'>
      ...
      <div className='flex'>
        <div className='Cards px-5 py-5 grid grid-cols-1 md:grid-cols-3 mx-auto  gap-5  '>
          {
            menudata.map((item) => {
              return (
